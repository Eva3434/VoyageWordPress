...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Eva_20230104_voyage_f86396bfdbcd03601465_20230104132926_archive.zip';
        const ARCHIVE_SIZE       = '62684293';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f86396b-04132926';
        const SECONDARY_PACKAGE_HASH = 'd7d7bee-04132926';
        const VERSION            = '1.5.1';
